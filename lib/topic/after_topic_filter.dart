...
class AfterTopicFilter extends StatefulWidget {
  final Map<String, dynamic> filters;

  const AfterTopicFilter({Key? key, required this.filters}) : super(key: key);

  @override
  _AfterTopicFilterState createState() => _AfterTopicFilterState();
}

class _AfterTopicFilterState extends State<AfterTopicFilter> {
