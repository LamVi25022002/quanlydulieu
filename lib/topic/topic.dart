                        ...
                        child: SingleChildScrollView(
                          ...
                          child: DataTable(
                            ...
                            columns: [
                              ...
                              DataColumn(label: const Text('Mã số', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16))),
                              DataColumn(label: const Text('Cấp quản lý', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16))),
                              DataColumn(label: const Text('Loại hình', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16))),
                                ...
                                cells: [
                                  ...
                                  DataCell(
                                    GestureDetector(
                                        ...
                                        child: Text('Cấp học viện')), // Thay thế với dữ liệu của bạn
                                  ),
                                  DataCell(
                                    GestureDetector(
                                        onTap: () {_navigateToDetailPage(context, _filteredRows[index]);
                                        },
                                        child: Text('Đề tài')), // Thay thế với dữ liệu của bạn
                                  ),
                                  DataCell(
                                      Row(
        ...
        child: FloatingActionButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => AddTopic(), // Điều hướng đến trang AddTopic
              ),
            );
          },
