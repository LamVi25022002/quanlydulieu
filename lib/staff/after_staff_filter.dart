...
class AfterStaffFilter extends StatefulWidget {
  final Map<String, dynamic> filters;

  const AfterStaffFilter({Key? key, required this.filters}) : super(key: key);

  @override
  _AfterStaffFilterState createState() => _AfterStaffFilterState();
}

class _AfterStaffFilterState extends State<AfterStaffFilter> {
    ...
    return SingleChildScrollView(
      ...
      child: DataTable(
        ...
        columns: [
          DataColumn(
            label: Container(
              width: 30, // Có thể điều chỉnh kích thước của cột
              child: Align(
