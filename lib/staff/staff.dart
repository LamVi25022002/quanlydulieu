        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 12),
              const Text(
                'Nếu xóa nhân viên này, bạn sẽ không thể khôi phục lại nữa. Bạn có chắc chắn muốn tiếp tục xóa không?',
                textAlign: TextAlign.center,
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: DataTable(
                            ...
                            columns: [
                              ...
                              DataColumn(label: const Text('Họ tên', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16))),
                              DataColumn(label: const Text('Mã nhân viên', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16))),
                              DataColumn(label: const Text('Chức vụ', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16))),
                                ...
                                cells: [
                                  ...
                                  DataCell(
                                    GestureDetector(
                                        ...
                                        child: Text('Nhân viên $index')), // Thay thế với dữ liệu của bạn
                                  ),
                                  DataCell(
                                    GestureDetector(
                                        onTap: () {_navigateToDetailPage(context, _filteredRows[index]);
                                  ...
                                  DataCell(
                                    GestureDetector(
                                        ...
                                        child: Text('Chức vụ')), // Thay thế với dữ liệu của bạn
                                  ),
                                  DataCell(
                                      Row(
