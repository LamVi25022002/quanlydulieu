...
class _HomeFilterState extends State<HomeFilter> {
  ...
  void _showBottomSheet(String title, List<String> options, Function(String) onSelected, {bool centerOptions = false}) {
              ...
              children: [
                ...
                ...options.map((String value) {
                  return ListTile(
                    title: Text(
                      value,
                      textAlign: centerOptions ? TextAlign.center : TextAlign.left, // Căn giữa hoặc trái
                    ),
                    onTap: () {
                      onSelected(value);
